========================================================================
    活动模板库：DmsClient 项目概述
========================================================================

应用程序向导已为您创建了此 DmsClient 项目，您可以在此基础之上
编写服务 (EXE)。
...
DmsClient.idl
    ...
    和 coclass 的 IDL 定义。
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明                 (DmsClient.h)
        GUID 定义                                (DmsClient_i.c)
        一个类型库                               (DmsClient.tlb)
        封送代码                                 (DmsClient_p.c 和 dlldata.c)

DmsClient.h
    此文件包含在 DmsClient.idl 中定义的项的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 DmsClient.pch 的预编译头 (PCH) 文件
...
DmsClientps.vcproj
	...
	dlldata.c、DmsClient_i.c 和 DmsClient_p.c，它们。
